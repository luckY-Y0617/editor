...
namespace Northstar.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260430162513_AddPublicShareLinksAndInviteDeliveryPhase10")]
    partial class AddPublicShareLinksAndInviteDeliveryPhase10
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Northstar.Domain.Security.ShareLink", b =>
                {
                    ...
                    b.HasIndex("WorkspaceId", "ResourceId", "ExpiresAt")
                        .HasDatabaseName("idx_share_links_public_document_active")
                    ...
                    b.ToTable("share_links", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("share_links_public_viewer_expiry_check", "audience <> 'public' OR (resource_type = 'document' AND role_key = 'viewer' AND subject_email IS NULL AND expires_at IS NOT NULL)");
