...
namespace Northstar.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260514065504_AddShareLinkManagementPauseV1")]
    partial class AddShareLinkManagementPauseV1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Northstar.Domain.Security.AccessRequest", b =>
                {
                    ...
                    b.Property<Guid?>("ResultingGrantId")
                        .HasColumnType("uuid")
                        .HasColumnName("resulting_grant_id");
                    ...
                    b.ToTable("access_requests", null, t =>
                        {
                            t.HasCheckConstraint("access_requests_requested_role_check", "requested_role IN ('owner', 'admin', 'editor', 'commenter', 'viewer')");

                            t.HasCheckConstraint("access_requests_resource_type_check", "resource_type IN ('collection', 'document')");

                            t.HasCheckConstraint("access_requests_status_check", "status IN ('pending', 'approved', 'denied', 'cancelled')");

                            t.HasCheckConstraint("access_requests_subject_type_check", "subject_type IN ('user', 'group')");
                        });
                });

            modelBuilder.Entity("Northstar.Domain.Security.EmailInviteDeliveryOutboxItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("WorkspaceId", "InviteId")
                    ...
                    b.ToTable("email_invite_delivery_outbox", null, t =>
                        {
                            t.HasCheckConstraint("email_invite_delivery_outbox_attempts_check", "attempt_count >= 0 AND max_attempts > 0 AND attempt_count <= max_attempts");

                            t.HasCheckConstraint("email_invite_delivery_outbox_status_check", "status IN ('pending', 'retry_scheduled', 'sent', 'failed')");
                        });
                });
            ...
            modelBuilder.Entity("Northstar.Domain.Security.PermissionNotification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Northstar.Domain.Security.PermissionNotificationPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("permission_notification_preferences", null, t =>
                        {
                            t.HasCheckConstraint("permission_notification_preferences_resource_type_check", "resource_type IS NULL OR resource_type IN ('collection', 'document')");

                            t.HasCheckConstraint("permission_notification_preferences_scope_check", "(resource_type IS NULL AND resource_id IS NULL) OR (resource_type IS NOT NULL AND resource_id IS NOT NULL)");

                            t.HasCheckConstraint("permission_notification_preferences_watch_mute_check", "NOT (watched AND muted)");
                        });
                });
            ...
            modelBuilder.Entity("Northstar.Domain.Security.ResourceAccessGrant", b =>
                {
                    ...
                    b.HasIndex("WorkspaceId", "ResourceType", "ResourceId", "SubjectType")
                    ...
                    b.ToTable("resource_access_grants", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("resource_access_grants_subject_type_check", "subject_type IN ('user', 'group')");
                        });
                });
            ...
            modelBuilder.Entity("Northstar.Domain.Security.ResourceEmailInvite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<DateTimeOffset?>("DeliveryAttemptedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("delivery_attempted_at");
                    ...
                    b.HasIndex("WorkspaceId", "ResourceType", "ResourceId", "Email")
                        .IsUnique()
                        .HasDatabaseName("resource_email_invites_pending_resource_email_key")
                        .HasFilter("status = 'pending'");

                    b.ToTable("resource_email_invites", null, t =>
                        {
                            t.HasCheckConstraint("resource_email_invites_delivery_status_check", "delivery_status IN ('disabled', 'sent', 'failed')");

                            t.HasCheckConstraint("resource_email_invites_resource_type_check", "resource_type IN ('collection', 'document')");

                            t.HasCheckConstraint("resource_email_invites_role_key_check", "role_key IN ('viewer', 'commenter')");

                            t.HasCheckConstraint("resource_email_invites_status_check", "status IN ('pending', 'accepted', 'revoked', 'expired')");
                        });
                });

            modelBuilder.Entity("Northstar.Domain.Security.ScimToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("WorkspaceId", "RevokedAt", "ExpiresAt")
                        .HasDatabaseName("idx_scim_tokens_workspace_active");

                    b.ToTable("scim_tokens", (string)null);
                });

            modelBuilder.Entity("Northstar.Domain.Security.ShareLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("WorkspaceId", "ResourceType", "ResourceId", "ExpiresAt")
                    ...
                    b.ToTable("share_links", null, t =>
                        {
                            t.HasCheckConstraint("share_links_audience_check", "audience IN ('workspace', 'external', 'public')");
            ...
            modelBuilder.Entity("Northstar.Domain.Security.UserMfaMethod", b =>
                {
                    ...
                    b.ToTable("user_mfa_methods", null, t =>
                        {
                            t.HasCheckConstraint("user_mfa_methods_method_type_check", "method_type IN ('totp')");

                            t.HasCheckConstraint("user_mfa_methods_status_check", "status IN ('pending', 'enabled', 'disabled')");
                        });
                });

            modelBuilder.Entity("Northstar.Domain.Security.WorkspaceGroup", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("WorkspaceId", "ExternalProvider", "ExternalGroupId")
                        .IsUnique()
                    ...
                    b.ToTable("workspace_groups", null, t =>
                        {
                            t.HasCheckConstraint("workspace_groups_type_check", "type IN ('static', 'dynamic')");
                        });
                });

            modelBuilder.Entity("Northstar.Domain.Security.WorkspaceGroupMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId", "RemovedAt", "ExpiresAt")
                        .HasDatabaseName("idx_workspace_group_members_user_active");

                    b.ToTable("workspace_group_members", (string)null);
                });
            ...
            modelBuilder.Entity("Northstar.Domain.Security.AccessRequest", b =>
                {
                    ...
                    b.HasOne("Northstar.Domain.Security.ResourceAccessGrant", null)
                        .WithMany()
                        .HasForeignKey("ResultingGrantId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Northstar.Domain.Security.EmailInviteDeliveryOutboxItem", b =>
                {
                    b.HasOne("Northstar.Domain.Security.ResourceEmailInvite", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Northstar.Domain.Security.PermissionNotification", b =>
                {
                    b.HasOne("Northstar.Domain.Security.AccessRequest", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Northstar.Domain.Security.WorkspaceGroupMember", b =>
                {
                    ...
                    b.HasOne("Northstar.Domain.Security.WorkspaceGroup", null)
                        .WithMany()
