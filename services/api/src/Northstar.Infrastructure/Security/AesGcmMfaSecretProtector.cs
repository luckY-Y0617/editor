...
public sealed class AesGcmMfaSecretProtector : IMfaSecretProtector
{
    ...
    public AesGcmMfaSecretProtector(AuthOptions authOptions, MfaOptions mfaOptions)
    {
    ...
    public string Unprotect(string protectedSecret)
    {
        ...
        {
            throw new InvalidOperationException("MFA secret ciphertext is invalid.");
        }
    ...
    private byte[] GetKey()
    {
        ...
        {
            throw new InvalidOperationException("Auth:Mfa:SecretProtectionKey or Auth:Jwt:SigningKey is required for MFA secret protection.");
        }
