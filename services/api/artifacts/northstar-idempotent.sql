...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260430162513_AddPublicShareLinksAndInviteDeliveryPhase10') THEN
    ALTER TABLE resource_email_invites ADD delivery_attempted_at timestamp with time zone;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260430162513_AddPublicShareLinksAndInviteDeliveryPhase10') THEN
    ALTER TABLE resource_email_invites ADD delivery_error_code text;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260430162513_AddPublicShareLinksAndInviteDeliveryPhase10') THEN
    ALTER TABLE resource_email_invites ADD delivery_provider text NOT NULL DEFAULT 'noop';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260430162513_AddPublicShareLinksAndInviteDeliveryPhase10') THEN
    ALTER TABLE resource_email_invites ADD delivery_status text NOT NULL DEFAULT 'disabled';
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260430162513_AddPublicShareLinksAndInviteDeliveryPhase10') THEN
    CREATE INDEX idx_share_links_public_document_active ON share_links (workspace_id, resource_id, expires_at) WHERE audience = 'public' AND revoked_at IS NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260430162513_AddPublicShareLinksAndInviteDeliveryPhase10') THEN
    ALTER TABLE share_links ADD CONSTRAINT share_links_public_viewer_expiry_check CHECK (audience <> 'public' OR (resource_type = 'document' AND role_key = 'viewer' AND subject_email IS NULL AND expires_at IS NOT NULL));
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260430162513_AddPublicShareLinksAndInviteDeliveryPhase10') THEN
    CREATE INDEX idx_resource_email_invites_delivery_status_created ON resource_email_invites (delivery_status, created_at);
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260430162513_AddPublicShareLinksAndInviteDeliveryPhase10') THEN
    ALTER TABLE resource_email_invites ADD CONSTRAINT resource_email_invites_delivery_status_check CHECK (delivery_status IN ('disabled', 'sent', 'failed'));
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260430162513_AddPublicShareLinksAndInviteDeliveryPhase10') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260430162513_AddPublicShareLinksAndInviteDeliveryPhase10', '8.0.11');
    END IF;
END $EF$;
COMMIT;
...
DO $EF$
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260430165840_AddPublicCollectionLinksAndLinkPasswordsPhase11') THEN
    DROP INDEX idx_share_links_public_document_active;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260430165840_AddPublicCollectionLinksAndLinkPasswordsPhase11') THEN
    ALTER TABLE share_links DROP CONSTRAINT share_links_public_viewer_expiry_check;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260430165840_AddPublicCollectionLinksAndLinkPasswordsPhase11') THEN
    ALTER TABLE share_links ADD password_hash text;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260430165840_AddPublicCollectionLinksAndLinkPasswordsPhase11') THEN
    CREATE INDEX idx_share_links_public_active ON share_links (workspace_id, resource_type, resource_id, expires_at) WHERE audience = 'public' AND revoked_at IS NULL;
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260430165840_AddPublicCollectionLinksAndLinkPasswordsPhase11') THEN
    ALTER TABLE share_links ADD CONSTRAINT share_links_password_public_check CHECK (password_hash IS NULL OR audience = 'public');
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260430165840_AddPublicCollectionLinksAndLinkPasswordsPhase11') THEN
    ALTER TABLE share_links ADD CONSTRAINT share_links_public_viewer_expiry_check CHECK (audience <> 'public' OR (resource_type IN ('document', 'collection') AND role_key = 'viewer' AND subject_email IS NULL AND expires_at IS NOT NULL));
    END IF;
END $EF$;
...
BEGIN
    IF NOT EXISTS(SELECT 1 FROM "__EFMigrationsHistory" WHERE "MigrationId" = '20260430165840_AddPublicCollectionLinksAndLinkPasswordsPhase11') THEN
    INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
    VALUES ('20260430165840_AddPublicCollectionLinksAndLinkPasswordsPhase11', '8.0.11');
    END IF;
END $EF$;
COMMIT;
